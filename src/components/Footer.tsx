...
export const Footer: React.FC = () => {
  return (
    <footer className="mt-16 border-t border-soc-border bg-soc-card/60 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-4 text-xs font-mono text-slate-400">
            ...
            >
              ...
              <span>github.com/yuvaadhika</span>
            </a>
            ...
            >
              ...
              <span>vercel.com/yuvaadhika</span>
            </a>
        ...
        <div className="mt-6 pt-6 border-t border-soc-border/60 text-center text-[11px] font-mono text-slate-500">
          <p>
